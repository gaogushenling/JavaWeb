...
public class HelloJavaWeb2 extends HttpServlet {
    /**
...
//            html += "<div>"+ order.getOrderId() +"</div>"+ "<div>"+ order.getStatus() +"</div>" +"<div>"+ order.getMemberId() +"</div>";
        ...
        html += "</table>";
        html += "<form action=\"/add\" method=\"get\"><input type=\"text\" name=\"OrderId\"><br><input type=\"text\" name=\"Status\"><br><input type=\"text\" name=\"MemberId\"><br><input type=\"submit\"></form>";
        html += "</body>";
        html += "</html>";
        /*3、将拼接的html发送给浏览器*/
        //设置响应格式
